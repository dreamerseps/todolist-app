...
- 테스트 수행 : 적절한 서브에이전트를 적용해 미리 작성한 테스트를 수행한다. -테스트 결과 통과했다면 docs/7-execution-plan.md 의 해당 Task의 완료조건을 체크한다.
- 테스트 결과 통과했다면 docs/7-excution-plan.md의 해당 Task완료조건을 체크한다.
